...
WORKFLOW=wf_ecliprepmap_pe # the prefix of the workflow cwl (without .cwl extension)

PIPELINE=REPELEMENTMAPPING  # workflow prefix
PIPELINEVERSION=1.0.0  # workflow version
