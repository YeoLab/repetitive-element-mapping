...
my $path = "/home/bay001/projects/codebase/repetitive-element-mapping/data/";
...
my $filelist_file = "/home/bay001/projects/codebase/repetitive-element-mapping/data/MASTER_filelist.wrepbaseandtRNA.enst2id.fixed.UpdatedSimpleRepeat";
...
my $pid = open(BOWTIE, "-|", "stdbuf -oL /projects/ps-yeolab/software/bowtie2-2.2.6/./bowtie2 -q --sensitive -a -p 3 --no-mixed --reorder -x $bowtie_db -1 $fastq_file1 -2 $fastq_file2 2> $bowtie_out");
