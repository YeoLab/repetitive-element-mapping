...
my %peaks;
my $repmask_bed_fi = "/home/elvannostrand/data/clip/CLIPseq_analysis/RNA_type_analysis/RepeatMask_hg19.bed";
...
for my $genelist_type ("SNORA","SNORD","RN7SK","RN7SL","RNU1","RNU105","RNU11","RNU12","RNU2","RNU3","RNU4","RNU4ATAC","RNU5A","RNU5B","RNU5D","RNU5E","RNU5F","RNU6","RNU6ATAC","RNU7","SCARNA","snoU109","snoU13","U8","VTRNA1","VTRNA2","VTRNA3","YRNA") {
    my $genelist_bed_file = "/home/elvannostrand/data/clip/CLIPseq_analysis/RNA_type_analysis/genelists.".$genelist_type.".bed";
