...
inputs:
  ...
  bowtieReferenceTar:
    ...
    default:
      class: File
      path: /projects/ps-yeolab/software/ecliprepmap/0.0.1/ecliprepmap_refdata/bowtie2_repetitive_elements_index.tar
  fileListFile1:
    type: File
    default:
       class: File
       path: /projects/ps-yeolab/software/ecliprepmap/0.0.1/ecliprepmap_refdata/MASTER_filelist.wrepbaseandtRNA.enst2id.fixed.UpdatedSimpleRepeat
  fileListFile2:
    type: File
    default:
      class: File
      path: /projects/ps-yeolab/software/ecliprepmap/0.0.1/ecliprepmap_refdata/ALLRepBase_elements.id_table.FULL
  ...
  gencodeGTF:
    ...
    default:
      ...
      path: /projects/ps-yeolab/software/ecliprepmap/0.0.1/ecliprepmap_refdata/gencode.v19.chr_patch_hapl_scaff.annotation.gtf
  gencodeTableBrowser:
    type: File
    default:
      class: File
      #path: "/projects/ps-yeolab/genomes/hg19/gencode_v19/gencode.v19.chr_patch_hapl_scaff.annotation.gtf.parsed_ucsc_tableformat"
      path: /projects/ps-yeolab/software/ecliprepmap/0.0.1/ecliprepmap_refdata/gencode.v19.chr_patch_hapl_scaff.annotation.gtf.parsed_ucsc_tableformat

  repMaskBEDFile:
    type: File
    default:
      class: File
      path: /projects/ps-yeolab/software/ecliprepmap/0.0.1/ecliprepmap_refdata/RepeatMask.bed
